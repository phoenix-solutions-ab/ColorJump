...
namespace ColorSwitchGame
{
	...
	/// </summary>
	public class CSGDestroyAfterDistance:MonoBehaviour 
	{
		...
		void CheckDistance()
		{
			...
			if ( Vector2.Distance( Camera.main.transform.position, transform.position) > destroyAfterDistance )    Destroy(gameObject);
		}
	}
}
